...
/* Utility class that uses d3.bisect to find the index in a given array, where a vacancy value can be inserted.
 This is different from normal bisectLeft; this function finds the nearest index to insert the vacancy value.

 For instance, lets say your array is [1,2,3,5,10,30], and you vacancy for 28.
...
nv.interactiveBisect = function (values, searchVal, xAccessor) {
    ...
    var _cmp = function(d, v) {
        ...
        // comparators where the second argument is the vacancy value against
