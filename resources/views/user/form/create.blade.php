                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group ">
                                ...
                                {!! Form::select('designation', $designations, null, ['class' =>'form-control select2-show-vacancy', 'placeholder' => __('label.select') , 'aria-describedby' => '', 'required']) !!}
                        ...
                        <div class="col-md-4">
                            <div class="form-group ">
                                ...
                                {!! Form::select('region', $regions, null, ['class' =>'form-control select2-show-vacancy', 'placeholder' => __('label.select') , 'aria-describedby' => '', 'required']) !!}
