                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 col-md-4">
                        <div class="form-group">
                            ...
                            {!! Form::select('relationship_cv_id', $relations, $family->relationship_cv_id, ['class' =>'form-control select2-show-vacancy', 'placeholder' => __('label.select') , 'aria-describedby' => '', 'required']) !!}
