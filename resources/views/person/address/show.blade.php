...
@section('content')
    ...
    <div class="col-lg-12 col-md-12">
        {!! Form::open(['route' => ['person.address.update', $address], 'method' => 'put',]) !!}
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 col-md-4">
                        <div class="form-group">
                            ...
                            {!! Form::select('district_id', $districts, $address->district_id, ['class' =>'form-control select2-show-vacancy', 'placeholder' => __('label.select') , 'aria-describedby' => '', 'required']) !!}
