<aside class="app-sidebar comb-sidebar">
    ...
    <ul class="side-menu">
        ...
        <li>
            <a class="side-menu__item" href="{{ url('/contact') }}"><i class="side-menu__icon fa fa-address-card"></i><span class="side-menu__label">Contact Details</span></a>
        </li>

        <li>
            <a class="side-menu__item" href="{{ url('/otherinfo') }}"><i class="side-menu__icon fa fa-file"></i><span class="side-menu__label">Other Information</span></a>
        </li>
        ...
        <li>
            <a class="side-menu__item" href="{{ url('/qualifications') }}"><i class="side-menu__icon fa fa-user-secret"></i><span class="side-menu__label">Qualifications</span></a>
        </li>

        <li>
            <a class="side-menu__item" href="{{ url('/experiences') }}"><i class="side-menu__icon fa fa-user-secret"></i><span class="side-menu__label">Experience</span></a>
        </li>

        <li>
            <a class="side-menu__item" href="{{ url('/reference') }}"><i class="side-menu__icon fa fa-user-secret"></i><span class="side-menu__label">Reference</span></a>
        </li>
